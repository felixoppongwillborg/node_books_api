...
beforeEach(async () => {
  ...
  await factory.createMany('Book', 2, [
    ...
    { id: 101, title: "Learn NodeJS with CraftAcademy - in test", AuthorId: author.id  }
  ])
})
...
describe("GET /api/v1/books", () => {
  ...
  it("is expected to respond with list of 2 books", () => {
...
describe("GET /api/v1/books/:id", () => {
  ...
  it('is expected to respond with a single books with a title', async () => {
    expect(response.body.book.title).to.equal("Learn NodeJS with CraftAcademy - in test")
  })
